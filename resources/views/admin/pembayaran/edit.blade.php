        ...
        <section class="row">
            <div class="col-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <form action="{{route('admin.pembayaran.update',$pembayaran->uuid)}}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pembayaran_via"
                                           ...
                                           name="pembayaran_via" value="{{old('pembayaran_via',$pembayaran->pembayaran_via)}}" required maxlength="40">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="jumlah_dibayarkan"
                                           ...
                                           name="jumlah_dibayarkan" value="{{old('jumlah_dibayarkan',$pembayaran->jumlah_dibayarkan)}}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="choices form-select @error('type_pembayaran') is-invalid @enderror"
                                        ...
                                        @if(!old('type_pembayaran',$pembayaran->type_pembayaran))
                                            <option value="" disabled selected>Select Tipe Kendaraan</option>
                                        @endif
                                        @foreach($type_pembayarans as $type_pembayaran)
                                            @if(old('type_pembayaran',$pembayaran->type_pembayaran) == $type_pembayaran->value)
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="choices form-select @error('status_pembayaran') is-invalid @enderror"
                                        ...
                                        @if(!old('status_pembayaran',$pembayaran->status_pembayaran))
                                            <option value="" disabled selected>Select Tipe Kendaraan</option>
                                        @endif
                                        @foreach($status_pembayarans as $status_pembayaran)
                                            @if(old('status_pembayaran',$pembayaran->status_pembayaran) == $status_pembayaran->value)
                                ...
                                <div class="form-group">
                                    <label for="reject_message">Rejected Message</label>
                                    <input type="text" id="reject_message"
                                           class="form-control round @error('reject_message') is-invalid @enderror"
                                           name="reject_message" value="{{old('reject_message',$pembayaran->reject_message)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="choices form-select @error('sewa_id') is-invalid @enderror"
                                        ...
                                        @if(!old('sewa_id',$pembayaran->sewa_id))
                                            <option value="" disabled selected>Select Transaksi Sewa</option>
                                        @endif
                                        @foreach($sewas as $sewa)
                                            @if(old('sewa_id',$pembayaran->sewa_id) == $sewa->id)
                                ...
                                <div class="form-group">
                                    ...
                                    @if($pembayaran->bukti_pembayaran)
                                        <img alt="bukti_pembayaran" class="img-fluid my-3" src="{{asset('/images/bukti_pembayaran/'.$pembayaran->bukti_pembayaran)}}">
                                    @endif
                                    <input type="file" class="image-preview-filepond" name="bukti_pembayaran" id="bukti_pembayaran">
                                </div>
