            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit data Sewa </h4>
                    </div>
                    <div class="card-body">
                        <div class="col-md-12">
                            <form action="{{route('admin.sewa.update',$sewa->uuid)}}" method="post">
                                @method('PUT')
                                @csrf
                                <div class="form-group">
                                    ...
                                    <input type="date" id="tanggal_sewa"
                                           ...
                                           name="tanggal_sewa" value="{{old('tanggal_sewa',$sewa->tanggal_sewa->format('Y-m-d'))}}" required>
                                    @error('tanggal_sewa')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="tanggal_perkiraan_kembali"
                                           ...
                                           name="tanggal_perkiraan_kembali" value="{{old('tanggal_perkiraan_kembali',$sewa->tanggal_perkiraan_kembali->format('Y-m-d'))}}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="choices form-select @error('kendaraan_id') is-invalid @enderror"
                                        ...
                                        @foreach($kendaraans as $kendaraan)
                                            @if(old('kendaraan_id',$sewa->kendaraan_id) == $kendaraan->id)
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="choices form-select @error('users_id') is-invalid @enderror"
                                        ...
                                        @foreach($users as $user)
                                            @if(old('users_id',$sewa->users_id) == $user->id)
