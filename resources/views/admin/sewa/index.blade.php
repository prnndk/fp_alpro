                        ...
                        <table class="table table-striped" id="table1">
                            ...
                            @foreach($sewas as $sewa)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.sewa.show',$sewa->id)}}" class="btn btn-primary icon btn-sm"><i class="bi bi-eye"></i></a>
                                        <a href="{{route('admin.sewa.edit',$sewa->id)}}" class="btn btn-warning icon btn-sm"><i class="bi bi-pencil"></i></a>
