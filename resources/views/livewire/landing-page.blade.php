        ...
        <div class="col-auto col-md-4 col-xl-3 px-sm-2 px-0">
            <div class=" flex-column  align-items-sm-start px-3 pt-2 min-vh-100">
                ...
                <div class="form-group position-relative has-icon-right">
                    <input type="text" class="form-control rounded" wire:model.live="search" placeholder="Search Here...">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    @foreach($tipeKendaraans as $typeKendaraan)
                        <li class="nav-item">
                            <a href="#" class="nav-link px-0" wire:click.prevent="filterByType({{ $typeKendaraan->id }})">
